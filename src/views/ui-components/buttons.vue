        ...
        <div class="card">
          <div class="card-body">
            ...
            <p class="card-description">
              Use<code> &lt;b-button&gt; </code> for buttons basic buttons
            </p>
      ...
      <div class="col-md-6 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <p class="card-description">
              Use <code>.btn-inverse-*</code> with
              <code> &lt;b-button&gt; </code> for inverse styling
            </p>
            <div class="template-demo">
      ...
      <div class="col-md-6 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <p class="card-description">
              Use <code>.btn-rounded</code> with
              <code> &lt;b-button&gt; </code> for rounded buttons
            </p>
            <div class="template-demo">
              <b-button variant="primary" class="btn-fw btn-rounded"
                >Primary</b-button
              >
              <b-button variant="secondary" class="btn-fw btn-rounded"
                >Seconday</b-button
              >
              <b-button variant="success" class="btn-fw btn-rounded"
                >Success</b-button
              >
              <b-button variant="danger" class="btn-fw btn-rounded"
                >Danger</b-button
              >
              <b-button variant="warning" class="btn-fw btn-rounded"
                >Warning</b-button
              >
              <b-button variant="info" class="btn-fw btn-rounded"
                >Info</b-button
              >
              <b-button variant="light" class="btn-fw btn-rounded"
                >Light</b-button
              >
              <b-button variant="dark" class="btn-fw btn-rounded"
                >Dark</b-button
              >
              <b-button href="#" class="btn-fw btn-link btn-rounded"
                >Link</b-button
              >
            </div>
          </div>
      ...
      <div class="col-md-6 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <div class="template-demo">
              <b-button class="btn-fw btn-inverse-primary btn-rounded"
                >Primary</b-button
              >
              <b-button class="btn-fw btn-inverse-secondary btn-rounded"
                >Seconday</b-button
              >
              <b-button class="btn-fw btn-inverse-success btn-rounded"
                >Success</b-button
              >
              <b-button class="btn-fw btn-inverse-danger btn-rounded"
                >Danger</b-button
              >
              <b-button class="btn-fw btn-inverse-warning btn-rounded"
                >Warning</b-button
              >
              <b-button class="btn-fw btn-inverse-info btn-rounded"
                >Info</b-button
              >
              <b-button class="btn-fw btn-inverse-light btn-rounded"
                >Light</b-button
              >
              <b-button class="btn-fw btn-inverse-dark btn-rounded"
                >Dark</b-button
              >
              <b-button href="#" class="btn-fw btn-link btn-rounded"
                >Link</b-button
      ...
      <div class="col-md-6 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <p class="card-description">
              Buttons without fixed width (Auto width)
            </p>
            <div class="template-demo">
          ...
          <div class="card-body">
            ...
            <div class="template-demo">
              <b-button variant="success"
                ><i class="mdi mdi-cloud-download"></i>Upload</b-button
              >
              <b-button variant="warning"
                ><i class="mdi mdi-message-text"></i>Comments</b-button
              >
              ...
              <b-button variant="primary"
                ><i class="mdi mdi-printer"></i>Print</b-button
              >
              <b-button variant="dark"
                ><i class="mdi mdi-loop"></i>Reset</b-button
              >
            </div>
          </div>
        </div>
      ...
      <div class="col-md-6 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <div class="template-demo">
              <b-button-group>
                <b-button variant="outline-secondary" class="icon-btn"
            ...
            <div class="template-demo">
              <b-button-group>
                <b-button variant="danger" class="icon-btn"
                  ><i class="mdi mdi-heart-outline"></i
                ></b-button>
                <b-button variant="danger" class="icon-btn"
                  ><i class="mdi mdi-clock"></i
      ...
      <div class="col-md-6 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <div class="template-demo">
              <b-button variant="primary" class="social-btn"
                ><i class="mdi mdi-facebook"></i
              ></b-button>
              <b-button variant="info" class="social-btn"
                ><i class="mdi mdi-twitter"></i
              ></b-button>
              <b-button variant="success" class="social-btn"
                ><i class="mdi mdi-dribbble"></i
              ></b-button>
              <b-button variant="danger" class="social-btn"
                ><i class="mdi mdi-linkedin"></i
              ></b-button>
              <b-button variant="warning" class="social-btn"
                ><i class="mdi mdi-google-plus"></i
              ></b-button>
              <br />
              <b-button variant="facebook" class="social-btn"
                ><i class="mdi mdi-facebook"></i
              ></b-button>
              <b-button variant="twitter" class="social-btn"
                ><i class="mdi mdi-twitter"></i
              ></b-button>
              <b-button variant="dribbble" class="social-btn"
                ><i class="mdi mdi-dribbble"></i
              ></b-button>
              <b-button variant="linkedin" class="social-btn"
                ><i class="mdi mdi-linkedin"></i
              ></b-button>
              <b-button variant="google" class="social-btn"
                ><i class="mdi mdi-google-plus"></i
              ></b-button>
            </div>
          </div>
          <div class="card-body">
            ...
            <div class="template-demo">
              <b-button variant="primary" class="social-btn btn-rounded"
                ><i class="mdi mdi-facebook"></i
              ></b-button>
              <b-button variant="info" class="social-btn btn-rounded"
                ><i class="mdi mdi-twitter"></i
              ></b-button>
              <b-button variant="success" class="social-btn btn-rounded"
                ><i class="mdi mdi-dribbble"></i
              ></b-button>
              <b-button variant="danger" class="social-btn btn-rounded"
                ><i class="mdi mdi-linkedin"></i
              ></b-button>
              <b-button variant="warning" class="social-btn btn-rounded"
                ><i class="mdi mdi-google-plus"></i
              ></b-button>
              <br />
              <b-button variant="facebook" class="social-btn btn-rounded"
                ><i class="mdi mdi-facebook"></i
              ></b-button>
              <b-button variant="twitter" class="social-btn btn-rounded"
                ><i class="mdi mdi-twitter"></i
              ></b-button>
              <b-button variant="dribbble" class="social-btn btn-rounded"
                ><i class="mdi mdi-dribbble"></i
              ></b-button>
              <b-button variant="linkedin" class="social-btn btn-rounded"
                ><i class="mdi mdi-linkedin"></i
              ></b-button>
              <b-button variant="google" class="social-btn btn-rounded"
                ><i class="mdi mdi-google-plus"></i
              ></b-button>
            </div>
          </div>
