          ...
          <div class="card-body">
            ...
            <b-tabs>
              ...
              <b-tab title="Profile">
                ...
                Deleniti eveniet, sapiente corrupti, vitae excepturi nulla
                soluta esse in ex, dignissimos velit rerum maiores asperiores!
              </b-tab>
              <b-tab title="Contact">
                Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                Mollitia quibusdam assumenda fugit velit quis hic nulla
                necessitatibus? Nulla, possimus rerum quia sapiente
                necessitatibus!
              </b-tab>
            </b-tabs>
          </div>
        ...
        <div class="card">
          <div class="card-body">
            ...
            <b-tabs class="tab-minimal tab-minimal-success">
              ...
              <b-tab
                title="<i class='mdi mdi-message-text-outline'></i>Contact"
              >
                Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                Mollitia quibusdam assumenda fugit velit quis hic nulla
                necessitatibus? Nulla, possimus rerum quia sapiente
                ...
                <div class="row">
                  <div class="col-md-4">
                    <img
                      ...
                      src="../../assets/images/samples/300x300/01.jpg"
                      alt=""
                    />
                  </div>
                  <div class="col-md-8">
