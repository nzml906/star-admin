        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="list d-flex align-items-center border-bottom py-3">
              <img
                class="img-sm rounded-circle"
                src="../../src/assets/images/faces/face7.jpg"
                alt=""
              />
              <div class="wrapper w-100 ml-3">
            ...
            <div class="list d-flex align-items-center pt-3">
              <img
                class="img-sm rounded-circle"
                src="../../src/assets/images/faces/face6.jpg"
                alt=""
              />
              <div class="wrapper w-100 ml-3">
          ...
          <div class="card-body">
            ...
            <div class="wrapper d-flex align-items-center py-2 border-bottom">
              ...
              <div class="wrapper ml-3">
                ...
                <small class="text-muted mb-0"
                  ><i class="mdi mdi-map-marker-outline mr-1"></i>New York City,
                  USA</small
                >
              </div>
            ...
            <div class="wrapper d-flex align-items-center py-2 border-bottom">
              ...
              <div class="wrapper ml-3">
                ...
                <small class="text-muted mb-0"
                  ><i class="mdi mdi-map-marker-outline mr-1"></i>Florida,
                  USA</small
                >
              </div>
            ...
            <div class="wrapper d-flex align-items-center py-2 border-bottom">
              ...
              <div class="wrapper ml-3">
                ...
                <small class="text-muted mb-0"
                  ><i class="mdi mdi-map-marker-outline mr-1"></i>Arkansas,
                  USA</small
                >
              </div>
              <div class="badge badge-pill badge-info ml-auto px-1 py-1">
            ...
            <div class="wrapper d-flex align-items-center py-2 border-bottom">
              ...
              <div class="wrapper ml-3">
                ...
                <small class="text-muted mb-0"
                  ><i class="mdi mdi-map-marker-outline mr-1"></i>Arizon,
                  USA</small
                >
              </div>
              <div class="badge badge-pill badge-success ml-auto px-1 py-1">
            ...
            <div class="wrapper d-flex align-items-center py-2 mb-4">
              <img
                class="img-sm rounded-circle"
                src="../../src/assets/images/faces/face9.jpg"
                alt="profile"
              />
              <div class="wrapper ml-3">
                <h6 class="ml-1 mb-1">Rafell John</h6>
                <small class="text-muted mb-0"
                  ><i class="mdi mdi-map-marker-outline mr-1"></i>Alaska,
                  USA</small
                >
              </div>
              <div class="badge badge-pill badge-success ml-auto px-1 py-1">
          ...
          <div class="card-body">
            ...
            <div class="preview-list">
              ...
              <div class="preview-item border-bottom px-0">
                <div class="preview-thumbnail">
                  <img
                    src="../../src/assets/images/faces/face11.jpg"
                    alt="image"
                    class="rounded-circle"
                  />
                </div>
